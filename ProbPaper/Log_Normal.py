...
ax.plot([xmin, xmax], [aa*xmin + bb, aa*xmax + bb], color='k', linestyle='-', linewidth=0.1, zorder=9)

# 文字のプロット
ax.text(xmin, ymax + (ymax-ymin)/50, "F(t) (%)   Median Ranks",
...
print('対数標準偏差 = {var_log:10.6f}'.format(**locals()))
