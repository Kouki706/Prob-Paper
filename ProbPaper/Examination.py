...
# 値のプロット
ax1.scatter(qqq,ppp,s = 7, marker ="," ,alpha=0.8,linewidths=0.1,c="fuchsia",ec = "green" ,zorder=10)
...
# 値のプロット
ax2.scatter(qqq,ppp,s = 7, marker ="^" ,alpha=0.8,linewidths=0.1,c="lime",ec = "navy" ,zorder=10)
...
# 値のプロット
ax3.scatter(qqq,ppp,s = 7, alpha=0.8,linewidths=0.1,c="mediumslateblue",ec = "navy" ,zorder=10)
...
# 値のプロット
ax4.scatter(qqq,ppp,s = 7, marker ="x" ,alpha=0.8,linewidths=0.1,c="red" ,zorder=10)
